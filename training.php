...
<div class="panel-group" id="accordion">
   <div class="panel panel-default">
      <div class="panel-heading">
         <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#developer">
            DEVELOPER
            </a>
         </h4>
      ...
      <div id="developer" class="panel-collapse collapse in">
         <div class="panel-body">
            ...
            <br>
            <h5>Prerequisite &amp; Target Audience : </h5>
   ...
   <div class="panel panel-default">
      <div class="panel-heading">
         <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#administrator">
            ADMINISTRATOR
            </a>
         </h4>
         <div class="trainingNavRight">
   ...
   <div class="panel panel-default">
      <div class="panel-heading">
         <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#datascience">
            DATA SCIENCE
            </a>
         </h4>
         <div class="trainingNavRight">
      ...
      <div class="modal-content">
         ...
         <form id="contact-form" class="contact-work-form2" style="margin-bottom: 0px;">
            <div class="modal-body">
                  ...
                  <div class="textarea-input">
                     <textarea name="comment" class="surveyText" id="comment2" placeholder="How much actual Java experience do you feel would be necessary to take this course?" required></textarea>
                     <span><i class="fa fa-comment"></i></span>
                  </div>
         ...
         <div class="modal-footer">
            <input type="submit" data-dismiss="modal" name="developerSurvey-submit" class="submit_contact main-form" value="Submit">
         </div>
         </form>
      </div>
      <!-- /.modal-content -->
...
<div class="modal fade" id="administratorSurvey" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">Administrator Survey</h4>
         </div>
         <form id="contact-form" class="contact-work-form2" style="margin-bottom: 0px;">
            <div class="modal-body">
                  <div class="text-input">
